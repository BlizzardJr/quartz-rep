...
Test: <a href="#east-gard" data-for="east-gard" class="">East Gard&nbsp;</a>

Test: [Link to Ovira](#ovira)

<a href="#the-age-of-obliviousness" data-for="the-age-of-obliviousness">The age of Obliviousness&nbsp;</a>
 ...
 ![Description|left|small](./Bilderoldtown/Eastern_Bridge.jpg)
...
> [!INFO|wmicro no-title txt-c] (./Bilderoldtown/Eastern_Bridge.jpg)

 > [Bridge](./Bilderoldtown/Eastern_Bridge.jpg)
...
<div style="width: 100%;">
  <div style="width: 48%; float: left;">![Bridge](./Bilderoldtown/Eastern_Bridge.jpg)</div>
  <div style="width: 4%; float: left;"></div> <!-- This one is a spacer -->
  <div style="width: 48%; float: left;">Text and tests</div>
</div>
...
![hsmall left|hsmall left](overbanner_oldtown.jpg "wsmall left")
![hsmall left|wsmall left](overbanner_oldtown.jpg "hsmall left")
![wsmall left|hsmall left](overbanner_oldtown.jpg "hsmall left")
![wsmall left|wsmall left](overbanner_oldtown.jpg "wsmall left")
![hsmall left|hsmall left](overbanner_oldtown.jpg "hsmall left")
![hsmall left|hsmall left](overbanner_oldtown.jpg "hsmall left")
![hsmall left|hsmall left](overbanner_oldtown.jpg "hsmall left")
![hsmall left|hsmall left](overbanner_oldtown.jpg "hsmall left")
![hsmall left|hsmall left](overbanner_oldtown.jpg "hsmall left")
...
## Infrastructure 
> [!infobox-500]
> ![Bridge|left](./Bilderoldtown/Eastern_Bridge.jpg)
...
The Kalworth bridge is the biggest drawbridge in the known world allowing 500-ton ships to pass through it. A smaller harbor can be found in East Gard that allows citizens to take smaller boats out to the city's eastern archipelago. In the cities northern part of Lower Imari, a fishing harbor can also be found where the cities vast majority of fish comes from. 
> [!image]
> ![[./Bilderoldtown/Eastern_Bridge.jpg]]
...
## Imports and Exports 
![[./Bilderoldtown/Eastern_Bridge.jpg|inlL|500]]
...
# Culture
![htall right](./Bilderoldtown/Eastern_Bridge.jpg "Tall right-aligned image")
